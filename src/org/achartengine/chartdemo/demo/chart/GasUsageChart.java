 ...
 */
public class GasUsageChart extends AbstractChart {
  /**
  ...
  public String getDesc() {
    return "The amount of gas used across several years (time chart)";
  }
  ...
  public Intent execute(Context context) {
    String[] titles = new String[] { "Gas Usage Since Inception" };
    ...
    setChartSettings(renderer, "Gas Usage", "Date", "m^3", dateValues[0].getTime(),
