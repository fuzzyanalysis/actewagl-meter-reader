 ...
 */
public class ElectricityUsageChart extends AbstractChart {
  /**
  ...
  public String getDesc() {
    return "The amount of electricity used across several years (time chart)";
  }
  ...
  public Intent execute(Context context) {
    String[] titles = new String[] { "New electricity", "Fixed electricity" };
    ...
    setChartSettings(renderer, "Electricity usage", "Date", "kWh", dates.get(0)[0].getTime(),
